...
GEN1_MOVES = [
    ...
    Move("Fire Punch", "Fire", 75, 100, 24, "A fiery punch. May cause a burn."),
    Move("Thunder Punch", "Electric", 75, 100, 24, "An electric punch. May cause paralysis."),
    Move("Ice Punch", "Ice", 75, 100, 24, "An icy punch. May cause freezing."),
